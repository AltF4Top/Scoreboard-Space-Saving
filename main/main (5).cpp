...
int main(){
	FILE *inf = fopen("/home/lenovo/Documents/laboratery/CBFQueSS/data/u1", "rb");
	...
	FILE *outf = fopen("/home/lenovo/Documents/laboratery/CBFQueSS/result/rr_freq_real_phi.txt", "a");
	//FILE *outf = stdout;
