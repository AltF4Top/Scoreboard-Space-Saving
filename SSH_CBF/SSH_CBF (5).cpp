...
SSH_CBF ::
SSH_CBF(uint32_t _k, uint32_t hsize, uint32_t nhf, uint32_t width, uint32_t nbit, uint32_t qlen, uint32_t _m):
	heap(_k, hsize), filter(nhf, width, nbit), qh(0), qt(0), QSIZE(qlen), m(_m),
	k(_k), baseM((uint32_t)(107285/pow(_k, 0.66))/10000000), cnt(0){
